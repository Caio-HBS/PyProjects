...
class Calculator:
    def __init__(self, root):
        ...
        self.green_division_button = tk.PhotoImage(file="buttons/green_division_button.png")
        ...
        self.text_label_inside_display = tk.Label(self.display_label, 
        ...
        division_button = tk.Button(self.root, 
        ...
        multiplication_button = tk.Button(self.root, 
        ...
        minus_button = tk.Button(self.root, 
        ...
        seven_button = tk.Button(self.root, 
        ...
        eight_button = tk.Button(self.root, 
        ...
        nine_button = tk.Button(self.root, 
        ...
        plus_button = tk.Button(self.root, 
        ...
        four_button = tk.Button(self.root, 
        ...
        five_button = tk.Button(self.root, 
        ...
        six_button = tk.Button(self.root, 
        ...
        one_button = tk.Button(self.root, 
        ...
        two_button = tk.Button(self.root, 
        ...
        three_button = tk.Button(self.root, 
        ...
        equal_button = tk.Button(self.root, 
        ...
        equal_button.grid(sticky="n", row=4, column=3, pady=(2, 2), rowspan=2, padx=(10, 10))


        #------------------------Fifth line of buttons--------------------------
        zero_button = tk.Button(self.root, 
        ...
        zero_button.grid(sticky="n", row=5, column=0, columnspan=2, pady=(15, 0), padx=(10, 10))

        dot_button = tk.Button(self.root, 
    ...
    def result(self):
        ...
        elif num1 == None or num1 == "" or num2 == None or num2 == "" or self.operator == "":
            return
