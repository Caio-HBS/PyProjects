...
search = dif(input("Select directory to analyze"))
new_directory = input("Select new directory for duplicates")
...
change_duplicates_directory(search.lower_quality, new_directory)
